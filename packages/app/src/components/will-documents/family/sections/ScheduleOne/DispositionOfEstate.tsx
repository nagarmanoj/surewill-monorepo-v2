export function DispositionOfEstate() {
  return (
    <div>
      ...
      <ol className="lower-alpha">
        ...
        <li>
          ...
          survives me; except where any child having attained the age of 18
          years (the <span className="font-semibold">preservation age</span>)
          requests in writing that my executors transfer all or some of it to
          such child absolutely, or deal with it in some other way, my executors
          may (but are not obliged to) do so.
        </li>
      </ol>
    </div>
  );
